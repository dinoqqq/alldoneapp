...
var Popover = /** @class */ (function (_super) {
    ...
    function Popover(props) {
        ...
        _this.onKeyDown = function (e) {
            var _a = _this.props, onClickOutside = _a.onClickOutside;
            if(e.key === 'Escape') {
                onClickOutside(e)
            }
        };
        _this.resizePopover = new ResizeObserver(entries => {
            ...
            var _f = [popoverRect.top + window.pageYOffset, popoverRect.left + window.pageXOffset], absoluteTop = _f[0], absoluteLeft = _f[1]
