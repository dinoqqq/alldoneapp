...
// JSON: We modded this file to fix a bug in Chrome
// by applying this commit https://github.com/necolas/react-native-web/commit/e22f0bebb3262f882497f8818d59f77139402d90
// We also added an extra prop: onScrollWhenDisabled to handle scrolling attempts
// even when scrolling is disabled, notice that no scrolling takes place in this case,
// the only thing that happens is that an event listener passed in that prop is fired.
// Relevant lines for the latter are in _this._createPreventableScrollHandler
    ...
    (function (_Component) {
        ...
        function ScrollViewBase() {
            ...
            _this._createPreventableScrollHandler = function (handler) {
                return function (e) {
                    ...
                    } else if (_this.props.onScrollWhenDisabled) {
                        _this.props.onScrollWhenDisabled(e)
                    }
                }
            }
        ...
        _proto.render = function render() {
            var _this$props = this.props,
                ...
                other = _objectWithoutPropertiesLoose(_this$props, [
                    'scrollEnabled',
                    'style',
