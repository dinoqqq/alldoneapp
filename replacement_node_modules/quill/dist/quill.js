    ...
    return /******/ (function (modules) {
        ...
        /******/ [
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var Quill = (function () {
                    ...
                    function Quill(container) {
                        ...
                        const QUILL_EDITOR_TEXT_INPUT_TYPE = '0'
                        const placeholderData = this.options.placeholder.split('#')
                        this.placeholder = placeholderData[0]
                        const editorType = placeholderData[1]
                        const editorId = placeholderData[2]
                        this.enablePasteListener = editorType === QUILL_EDITOR_TEXT_INPUT_TYPE

                        var html = this.container.innerHTML.trim()
                        this.container.classList.add('ql-container')
                        this.container.classList.add(`ql-container-${editorId}`)
                        this.container.innerHTML = ''
                        this.container.__quill = this
                        this.root = this.addContainer('ql-editor')
                        this.root.classList.add(`ql-editor-${editorId}`)
                        ...
                        this.history.clear()
                        if (this.placeholder) {
                            this.root.setAttribute('data-placeholder', this.placeholder)
                        }
                    ...
                    _createClass(Picker, [
                        ...
                        },
                        {
                            ...
                            value: function buildLabel() {
                                ...
                                if (!this.container.classList.contains('ql-header')) {
                        ...
                        },
                        {
                            ...
                            value: function selectItem(item) {
                                ...
                                var selectedIcon = item.querySelector('.ql-header-item-icon')
                                if (selectedIcon != null) {
                                    this.label.innerHTML = ''
                                    this.label.appendChild(selectedIcon.cloneNode(true))
                                }
                ...
                var History = (function (_Module) {
                    ...
                    _createClass(History, [
                        ...
                        },
                        {
                            key: 'redo',
                            value: function redo() {
                                const defaultEvent = this.options.beforeUndoRedo(this.stack, 'redo', 'undo')
                        ...
                        },
                        {
                            key: 'undo',
                            value: function undo() {
                                const defaultEvent = this.options.beforeUndoRedo(this.stack, 'undo', 'redo')
                                if (defaultEvent !== false) {
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var TEXT_COLORS = ['#091540', '#BD0303', '#F58E0A', '#07A873', '#0070E0', '#702EE6']

                var BACKGROUND_COLORS = ['#B7BDC8', '#FFC7C7', '#FFE6C7', '#ADF0D9', '#C7E3FF', '#DBC7FF']
                            ...
                            value: function buildButtons(buttons, icons) {
                                buttons.forEach(function (button) {
                                    ...
                                    if (button.hasAttribute('data-html')) {
                                        customHtml = button.getAttribute('data-html')
                                    }
                                    ...
                                    className.split(/\s+/).forEach(function (name) {
                                        ...
                                        if (name === 'direction') {
                                            button.innerHTML = icons[name][''] + icons[name]['rtl'] + customHtml
                                        } else if (typeof icons[name] === 'string') {
                                            button.innerHTML = icons[name] + customHtml
                                        } else {
                                            var value = button.value || ''
                                            if (value != null && icons[name][value]) {
                                                button.innerHTML = icons[name][value] + customHtml
                                            }
                                        }
                                    })
                                })
                                ...
                                this.pickers = selects.map(function (select) {
                                    if (select.classList.contains('ql-align')) {
                                        ...
                                        if (select.querySelector('option') == null) {
                                            fillSelect(
                                                select,
                                                format === 'background' ? BACKGROUND_COLORS : TEXT_COLORS,
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var Clipboard = (function (_Module) {
                    ...
                    function Clipboard(quill, options) {
                        ...
                        if (this.quill.enablePasteListener) {
                        ...
                        },
                        {
                            ...
                            value: function onPaste(e) {
                                ...
                                setTimeout(function () {
                                    ...
                                    if (_this2.quill.enablePasteListener) {
                                        _this2.quill.setSelection(
                                            delta.length() - range.length,
                                            _quill2.default.sources.SILENT
                                        ) // Fixes scroll to top on paste
                                        _this2.quill.scrollingContainer.scrollTop = scrollTop // Fixes scroll to top on paste
                                        _this2.quill.focus() // Fixes scroll to top on paste
                                    }
                                }, 1)
                            },
                        },
                                ...
                                this.matchers.forEach(function (pair) {
                                    ...
                                    switch (selector) {
                                        ...
                                        case Node.ELEMENT_NODE:
                                            ...
                                            break
                                        default:
                                            ;[].forEach.call(_this3.container.querySelectorAll(selector), function (
                                                node
                                            ) {
                                                // TODO use weakmap
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var ColorPicker = (function (_Picker) {
                    ...
                    function ColorPicker(select, label) {
                        ...
                        var customHTML = ''
                        if (this.select.hasAttribute('data-html')) {
                            customHTML = this.select.getAttribute('data-html')
                        }

                        _this.label.innerHTML = label + customHTML
                    ...
                    _createClass(SnowTooltip, [
                        {
                            ...
                            value: function listen() {
                                ...
                                this.quill.on(_emitter2.default.events.SELECTION_CHANGE, function (
                                    range,
                                    oldRange,
                                    source
                                ) {
                                    ...
                                    if (range.length === 0 && source === _emitter2.default.sources.USER) {
                                        ...
                                        if (link != null && link.domNode.innerHTML.startsWith('<span class="ql-url"')) {
                                            _this3.linkRange = new _selection.Range(range.index - offset, link.length())
                                            const href = link.domNode.innerHTML.split(' ')[2]
                                            if (href) {
                                                const url = href.substring(6, href.length - 1)
                                                var preview = url /*_link2.default.formats(link.domNode);*/
